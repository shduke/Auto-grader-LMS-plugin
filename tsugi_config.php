...
// $wwwroot = 'http://colab-sbx-401.oit.duke.edu/tsugi';   // For MAMP
...
$CFG->ownername = 'Zachary Marion';  // 'Charles Severance'
$CFG->owneremail = 'zachary.marion@duke.edu'; // 'csev@example.com'
...
$CFG->pdo       = 'mysql:host=localhost;port=8889;dbname=tsugi'; // MAMP
$CFG->dbuser    = 'ltiuser';
...
$CFG->tool_folders = array("admin", "mod", "samples", "exercises", "../tsugi-php-standalone", "../apt_files");
